...
const NotFound = () => {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      <div className="rounded-3xl border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 print:bg-white p-10 shadow-sm dark:shadow-glow print:shadow-none backdrop-blur-xl">
        ...
        <p className="mt-3 max-w-md text-sm text-slate-600 dark:text-slate-400 print:text-slate-700">
