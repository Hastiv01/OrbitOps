...
const Settings = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="rounded-3xl border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-gradient-to-br from-slate-900/90 to-slate-800/80 p-6 shadow-sm dark:shadow-glow print:shadow-none">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-400 print:text-slate-700">Switch between dark and light themes</p>
                    </div>
                  </div>
              ...
              <div className="rounded-3xl border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 print:bg-white p-5 shadow-sm dark:shadow-glow print:shadow-none backdrop-blur-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 print:text-slate-700">Control which alerts you receive</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.key} className="flex items-center justify-between rounded-2xl border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-slate-50 dark:bg-slate-800/80 print:bg-white px-4 py-3">
              ...
              <div className="rounded-3xl border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 print:bg-white p-5 shadow-sm dark:shadow-glow print:shadow-none backdrop-blur-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 print:text-slate-700">Manage your operator profile</p>
                  </div>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label className="block text-sm font-medium text-slate-600 dark:text-slate-300 print:text-slate-800 mb-1">Name</label>
                    <input type="text" value={profile.name} onChange={e => setProfile({ ...profile, name: e.target.value })} className="w-full rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-4 py-2 text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-600 dark:text-slate-300 print:text-slate-800 mb-1">Email</label>
                    <input type="email" value={profile.email} onChange={e => setProfile({ ...profile, email: e.target.value })} className="w-full rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-4 py-2 text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-600 dark:text-slate-300 print:text-slate-800 mb-1">Role</label>
                    <select value={profile.role} onChange={e => setProfile({ ...profile, role: e.target.value })} className="w-full rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-4 py-2 text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none">
                      <option value="Operator" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">Operator</option>
                      <option value="Administrator" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">Administrator</option>
                      <option value="Analyst" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">Analyst</option>
                      <option value="Viewer" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">Viewer</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-600 dark:text-slate-300 print:text-slate-800 mb-1">Timezone</label>
                    <select value={profile.timezone} onChange={e => setProfile({ ...profile, timezone: e.target.value })} className="w-full rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-4 py-2 text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none">
                      <option value="UTC" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">UTC</option>
                      <option value="EST" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">EST (UTC-5)</option>
                      <option value="CET" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">CET (UTC+1)</option>
                      <option value="IST" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">IST (UTC+5:30)</option>
                      <option value="JST" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">JST (UTC+9)</option>
                    </select>
                  </div>
                </div>
              ...
              <div className="rounded-3xl border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 print:bg-white p-5 shadow-sm dark:shadow-glow print:shadow-none backdrop-blur-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 print:text-slate-700">Configure service endpoints</p>
                  </div>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input type="password" value={apiConfig.apiKey} onChange={e => setApiConfig({ ...apiConfig, apiKey: e.target.value })} placeholder="Enter API key" className="w-full rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-4 py-2 text-slate-900 dark:text-white print:text-black placeholder-slate-400 dark:placeholder-slate-500 focus:border-sky-500 focus:outline-none" />
                  </div>
                  <div>
                    ...
                    <input type="number" value={apiConfig.timeout} onChange={e => setApiConfig({ ...apiConfig, timeout: e.target.value })} className="w-full rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-4 py-2 text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none" />
                  </div>
                </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="border-b border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Name</th>
                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Status</th>
                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Orbit</th>
                        <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Monitoring</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-200 dark:divide-white/5 print:divide-slate-300">
                      {satellites.map(sat => (
                        <tr key={sat.id} className="transition hover:bg-white dark:bg-slate-800">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="border-b border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Name</th>
                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Country</th>
                        <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Status</th>
                        <th className="px-4 py-3 text-right text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Monitoring</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-200 dark:divide-white/5 print:divide-slate-300">
                      {groundStations.map(gs => (
                        <tr key={gs.id} className="transition hover:bg-white dark:bg-slate-800">
              ...
              <div className="mb-4 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <select value={logLevel} onChange={e => setLogLevel(e.target.value)} className="rounded-lg border border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800 px-3 py-1.5 text-sm text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none">
                    <option value="" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">All Levels</option>
                    ...
                    <option value="DEBUG" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">DEBUG</option>
                  </select>
                </div>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="border-b border-slate-200 dark:border-slate-700 print:border-slate-300 bg-white dark:bg-slate-800">
                    <tr>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Timestamp</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Level</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Source</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold text-slate-600 dark:text-slate-400 print:text-slate-700">Message</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200 dark:divide-white/5 print:divide-slate-300">
