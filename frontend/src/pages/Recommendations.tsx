    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-slate-500 dark:text-slate-400 print:text-slate-700">AI-generated insights and optimization suggestions</p>
        </div>
      ...
      {selectedRec && (
        <div className="rounded-3xl border border-sky-500/30 bg-white dark:bg-white/10 print:bg-white p-6 shadow-sm dark:shadow-glow print:shadow-none backdrop-blur-xl">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-lg font-semibold text-slate-900 dark:text-white print:text-black">{selectedRec.title}</p>
              <p className="text-sm text-slate-500 dark:text-slate-400 print:text-slate-700">{selectedRec.description}</p>
            </div>
            <button onClick={() => setSelectedRec(null)} className="rounded-lg bg-white dark:bg-white/10 print:bg-white p-2 text-slate-500 dark:text-slate-400 print:text-slate-700 hover:bg-white/20 transition"><FiX /></button>
          </div>

          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-4">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Why Generated</p>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 print:text-slate-800">{selectedRec.whyGenerated}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-4">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Expected Benefit</p>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 print:text-slate-800">{selectedRec.expectedBenefit}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-4">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Suggested Action</p>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Affected Mission</p>
              <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white print:text-black">{selectedRec.affectedMission}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Affected Satellite</p>
              <p className="mt-1 text-sm font-medium text-slate-900 dark:text-white print:text-black">{selectedRec.affectedSatellite}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Confidence Score</p>
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Priority</p>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Estimated Resource Saving</p>
              <p className="mt-1 text-sm font-medium text-emerald-400">{selectedRec.estimatedResourceSaving}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Estimated Battery Saving</p>
              <p className="mt-1 text-sm font-medium text-emerald-400">{selectedRec.estimatedBatterySaving}</p>
            </div>
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">Estimated Time Saving</p>
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              <input type="text" placeholder="Search..." value={historySearch} onChange={e => setHistorySearch(e.target.value)} className="rounded-lg border border-slate-200 dark:border-white/10 print:border-slate-300 bg-white dark:bg-white/5 py-1.5 pl-9 pr-4 text-sm text-slate-900 dark:text-white print:text-black placeholder-slate-400 dark:placeholder-slate-500 focus:border-sky-500 focus:outline-none" />
            </div>
            <select value={statusFilter} onChange={e => setStatusFilter(e.target.value)} className="rounded-lg border border-slate-200 dark:border-white/10 print:border-slate-300 bg-white dark:bg-white/5 px-3 py-1.5 text-sm text-slate-900 dark:text-white print:text-black focus:border-sky-500 focus:outline-none">
              ...
              <option value="Dismissed" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Dismissed</option>
            </select>
          </div>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-white/5 print:divide-slate-300">
              {filteredHistory.map(r => (
                <tr key={r.id} className="transition hover:bg-white dark:bg-white/5 cursor-pointer" onClick={() => setSelectedRec(r)}>
                  ...
                  <td className="px-4 py-3 text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">{new Date(r.createdAt).toLocaleDateString()}</td>
                  <td className="px-4 py-3 text-xs text-slate-500 dark:text-slate-400 print:text-slate-700">{r.appliedBy || '—'}</td>
                </tr>
              ))}
            </tbody>
          </table>
