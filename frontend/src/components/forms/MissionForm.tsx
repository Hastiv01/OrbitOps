  ...
  return (
    <Card>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Row 4: Payload */}
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-2">Payloads</label>
          <select
            multiple
            name="payload"
            ...
            onBlur={handleBlur}
            className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-white transition focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500/20"
          >
            {payloads.map((p) => (
          ...
          <p className="mt-1 text-xs text-slate-400">Hold Ctrl/Cmd to select multiple payloads</p>
        </div>
