...
const CommunicationWindowCard = ({ window }: CommunicationWindowCardProps) => {
  return (
    <div className="rounded-3xl border border-slate-200 dark:border-white/10 print:border-slate-300 bg-slate-50 dark:bg-slate-950/60 print:bg-white p-4 shadow-sm dark:shadow-glow print:shadow-none">
      ...
      <p className="mt-3 text-sm text-slate-500 dark:text-slate-400 print:text-slate-700">{window.satellite}</p>
